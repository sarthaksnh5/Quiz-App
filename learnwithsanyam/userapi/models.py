...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, email, password, types, address, mobile, yourClass, **extra_fields):
        if not email:
        ...
        user = self.model(email=email, types=types, address=address,
                          mobile=mobile, yourClass=yourClass, **extra_fields)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    yourClass = models.CharField(_('yourClass'), max_length=20)
